...
// // function Chat({ headerTitle, chatUsers = [], initialMessages = [], HeaderComponent, conversationId, userId }) {
// //   const [message, setMessage] = useState('');
// //   const [showEmojiPicker, setShowEmojiPicker] = useState(false);
...
// //           </div>
// //           <ul>
// //             {Array.isArray(chatUsers) && chatUsers.map((user, index) => (
// //               <li
// //                 key={index}
...
// //               <div className="flex items-center p-2 border-b bg-white">
// //                 <div className="w-10 h-10 bg-gray-300 rounded-full"></div>
// //                 <h2 className="ml-3 text-xl font-semibold">{currentChatUser.name}</h2>
// //               </div>
// //               <div className="flex-1 p-4 overflow-y-auto">
// //                 {messages.map((msg, index) => (
// //                   <div key={index} className={`flex ${msg.sender === userId ? 'justify-end' : 'justify-start'} mb-4`}>
// //                     <div className={`rounded p-2 ${msg.sender === userId ? 'bg-[#a39f74] text-white' : 'bg-gray-200'}`}>
// //                       <p>{msg.text}</p>
// //                     </div>
// //                   </div>
// //                 ))}
