...
// import { FaCalendarAlt, FaUser, FaPhone, FaEnvelope, FaMoneyBillWave, FaArrowAltCircleLeft } from 'react-icons/fa';
...
//       try {
//         const response = await axiosInstanceVendor.get(`/bookingdetails/${bookingId}`);
//         const bookingData = response.data
//         console.log(bookingData)
//         setBooking({
//             bookingId: bookingData._id,
//             customerName: bookingData.user.name, // Access user name directly
//             customerEmail: bookingData.user.email, // Access user email directly
//             contactPhone: bookingData.address.phone,
//             eventDate: format(new Date(bookingData.date), 'MMMM dd, yyyy'),
//             status: bookingData.status, // Adjusted to match the sample data
